...
// Class Definition
var SwapSigninTwoSteps = function() {
    // Elements
    var form;
    var submitButton;
    ...
    return {
        // Initialization
        init: function() {
            form = document.querySelector('#swap_sing_in_two_steps_form');
            submitButton = document.querySelector('#swap_sing_in_two_steps_submit');
