...
// Class definition
var SwapAccountSettingsProfileDetails = function () {
    // Private variables
    var form;
    var submitButton;
    var validation;
    ...
    return {
        init: function () {
            form = document.getElementById('swap_account_profile_details_form');
            
            if (!form) {
                return;
            }

            submitButton = form.querySelector('#swap_account_profile_details_submit');
