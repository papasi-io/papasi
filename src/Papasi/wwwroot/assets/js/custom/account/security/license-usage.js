...
// Class definition
var SwapAccountSecurityLicenseUsage = function () {
    // Private functions
    var initLicenceCopy = function() {
        SwapUtil.each(document.querySelectorAll('#swap_security_license_usage_table [data-action="copy"]'), function(button) {
            var tr = button.closest('tr');
            var license = SwapUtil.find(tr, '[data-bs-target="license"]');
