...
// Class definition
var SwapCustomerViewStatements = function () {

    // Private functions
    // Init current year datatable
    var initStatementYearCurrent = function () {
        // Define table element
        const id = '#swap_customer_view_statement_table_1';
    ...
    var initStatementYear2020 = function () {
        // Define table element
        const id = '#swap_customer_view_statement_table_2';
        var table = document.querySelector(id);
    ...
    var initStatementYear2019 = function () {
        // Define table element
        const id = '#swap_customer_view_statement_table_3';
        var table = document.querySelector(id);
    ...
    var initStatementYear2018 = function () {
        // Define table element
        const id = '#swap_customer_view_statement_table_4';
        var table = document.querySelector(id);
