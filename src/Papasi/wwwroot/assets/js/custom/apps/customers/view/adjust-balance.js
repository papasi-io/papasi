...
// Class definition
var SwapModalAdjustBalance = function () {
    var element;
    var submitButton;
    var cancelButton;
    var closeButton;
    ...
    var handleBalanceCalculator = function () {
        ...
        maskInput = document.getElementById('swap_modal_inputmask');
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#swap_modal_adjust_balance');
            modal = new bootstrap.Modal(element);

            form = element.querySelector('#swap_modal_adjust_balance_form');
            submitButton = form.querySelector('#swap_modal_adjust_balance_submit');
            cancelButton = form.querySelector('#swap_modal_adjust_balance_cancel');
            closeButton = element.querySelector('#swap_modal_adjust_balance_close');
