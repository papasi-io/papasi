...
// Class definition
var SwapCustomerViewInvoices = function () {

    // Private functions
    // Init current year datatable
    var initInvoiceYearCurrent = function () {
        // Define table element
        const id = '#swap_customer_details_invoices_table_1';
    ...
    var initInvoiceYear2020 = function () {
        // Define table element
        const id = '#swap_customer_details_invoices_table_2';
        var table = document.querySelector(id);
    ...
    var initInvoiceYear2019 = function () {
        // Define table element
        const id = '#swap_customer_details_invoices_table_3';
        var table = document.querySelector(id);
    ...
    var initInvoiceYear2018 = function () {
        // Define table element
        const id = '#swap_customer_details_invoices_table_4';
        var table = document.querySelector(id);
