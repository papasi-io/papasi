...
// Class definition
var SwapUsersViewMain = function () {

    // Init login session button
    var initLoginSession = () => {
        const button = document.getElementById('swap_modal_sign_out_sesions');
    ...
    var initSignOutUser = () => {
        const signOutButtons = document.querySelectorAll('[data-swap-users-sign-out="single_user"]');
    ...
    const initDeleteTwoStep = () => {
        const deleteButton = document.getElementById('swap_users_delete_two_step');
    ...
    const initEmailPreferenceForm = () => {
        // Define variables
        const form = document.getElementById('swap_users_email_notification_form');
        const submitButton = form.querySelector('#swap_users_email_notification_submit');
        const cancelButton = form.querySelector('#swap_users_email_notification_cancel');
