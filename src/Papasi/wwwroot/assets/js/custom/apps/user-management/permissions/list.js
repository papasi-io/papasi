...
// Class definition
var SwapUsersPermissionsList = function () {
    // Shared variables
    var datatable;
    var table;
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-swap-permissions-table-filter="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-swap-permissions-table-filter="delete_row"]');
    ...
    return {
        // Public functions
        init: function () {
            table = document.querySelector('#swap_permissions_table');
