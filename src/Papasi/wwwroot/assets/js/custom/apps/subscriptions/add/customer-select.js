...
// Class definition
var SwapModalCustomerSelect = function() {
    // Private variables
    var element;
    ...
    var processs = function(search) {
        var timeout = setTimeout(function() {
            var number = SwapUtil.getRandomInt(1, 6);
	...
	return {
		init: function() {
            // Elements
            element = document.querySelector('#swap_modal_customer_search_handler');
            modal = new bootstrap.Modal(document.querySelector('#swap_modal_customer_search'));
            ...
            // Handle select
            SwapUtil.on(element, '[data-swap-search-element="customer"]', 'click', function() {
                modal.hide();
            });
		}
	};
