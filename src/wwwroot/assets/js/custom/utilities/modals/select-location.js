...
// Class definition
var SwapModalSelectLocation = function () {
    // Private variables
    ...
    var initMap = function() {
        ...
        // Define Map Location
        var leaflet = L.map('swap_modal_select_location_map', {
    ...
    return {
        init: function () {
            // Elements
			modal = document.querySelector('#swap_modal_select_location');

			if (!modal) {
				return;
			}
            
            locationSelectTarget = document.querySelector('#swap_modal_select_location_target');
            locationSelectButton = document.querySelector('#swap_modal_select_location_button');
