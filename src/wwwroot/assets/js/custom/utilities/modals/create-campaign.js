...
// Class definition
var SwapCreateCampaign = function () {
	// Elements
	var modal;
	var modalEl;
	...
	var initStepper = function () {
		...
		formSubmitButton.addEventListener('click', function (e) {
			...
			formSubmitButton.setAttribute('data-swap-indicator', 'on');

			// Simulate form submission
			setTimeout(function () {
				// Hide loading indication
				formSubmitButton.removeAttribute('data-swap-indicator');
	...
	var initForm = function () {
		// Init age slider
		var slider = document.querySelector("#swap_modal_create_campaign_age_slider");
		var valueMin = document.querySelector("#swap_modal_create_campaign_age_min");
		var valueMax = document.querySelector("#swap_modal_create_campaign_age_max");
		...
		// Init tagify
		var tagifyElement = document.querySelector('#swap_modal_create_campaign_location');
		var tagify = new Tagify(tagifyElement, {
			delimiters: null,
			templates: {
				tag: function (tagData) {
					const countryPath = tagifyElement.getAttribute("data-swap-flags-path") + tagData.value.toLowerCase().replace(/\s+/g, '-') + '.svg';
					try {
						// _ESCAPE_START_
		...
		// Init flatpickr
		$("#swap_modal_create_campaign_datepicker").flatpickr({
			altInput: true,
			enableTime: true,
			altFormat: "F j, Y H:i",
		...
		// Init dropzone
		var myDropzone = new Dropzone("#swap_modal_create_campaign_files_upload", {
		...
		const allDuration = document.querySelector('#swap_modal_create_campaign_duration_all');
		const fixedDuration = document.querySelector('#swap_modal_create_campaign_duration_fixed');
		const datepicker = document.querySelector('#swap_modal_create_campaign_datepicker');
		...
		// Init budget slider
		var budgetSlider = document.querySelector("#swap_modal_create_campaign_budget_slider");
		var budgetValue = document.querySelector("#swap_modal_create_campaign_budget_label");
		...
		const restartButton = document.querySelector('#swap_modal_create_campaign_create_new');
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#swap_modal_create_campaign');
			...
			stepper = document.querySelector('#swap_modal_create_campaign_stepper');
			form = document.querySelector('#swap_modal_create_campaign_stepper_form');
			formSubmitButton = stepper.querySelector('[data-swap-stepper-action="submit"]');
			formContinueButton = stepper.querySelector('[data-swap-stepper-action="next"]');
