...
// Class definition
var SwapModalOfferADealDetails = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = SwapModalOfferADeal.getStepper().querySelector('[data-swap-element="details-next"]');
			previousButton = SwapModalOfferADeal.getStepper().querySelector('[data-swap-element="details-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.SwapModalOfferADealDetails = window.SwapModalOfferADealDetails = module.exports = SwapModalOfferADealDetails;
}