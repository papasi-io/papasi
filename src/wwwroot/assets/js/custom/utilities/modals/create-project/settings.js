...
// Class definition
var SwapModalCreateProjectSettings = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#swap_modal_create_project_settings_logo", { 
	...
	return {
		...
		init: function () {
			...
			nextButton = SwapModalCreateProject.getStepper().querySelector('[data-swap-element="settings-next"]');
			previousButton = SwapModalCreateProject.getStepper().querySelector('[data-swap-element="settings-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.SwapModalCreateProjectSettings = window.SwapModalCreateProjectSettings = module.exports = SwapModalCreateProjectSettings;
}
