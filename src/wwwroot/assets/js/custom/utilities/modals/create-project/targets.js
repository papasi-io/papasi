...
// Class definition
var SwapModalCreateProjectTargets = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = SwapModalCreateProject.getStepper().querySelector('[data-swap-element="targets-next"]');
			previousButton = SwapModalCreateProject.getStepper().querySelector('[data-swap-element="targets-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.SwapModalCreateProjectTargets = window.SwapModalCreateProjectTargets = module.exports = SwapModalCreateProjectTargets;
}