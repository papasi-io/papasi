...
// Class definition
var SwapModalNewTicket = function () {
	var submitButton;
	var cancelButton;
	var validator;
	var form;
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#swap_modal_create_ticket_attachments", { 
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#swap_modal_new_ticket');
			...
			form = document.querySelector('#swap_modal_new_ticket_form');
			submitButton = document.getElementById('swap_modal_new_ticket_submit');
			cancelButton = document.getElementById('swap_modal_new_ticket_cancel');
