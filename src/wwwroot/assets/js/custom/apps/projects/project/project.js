...
// Class definition
var SwapProjectOverview = function () {
    // Colors
    var primary = SwapUtil.getCssVariableValue('--swap-primary');
    var lightPrimary = SwapUtil.getCssVariableValue('--swap-primary-light');
    var success = SwapUtil.getCssVariableValue('--swap-success');
    var lightSuccess = SwapUtil.getCssVariableValue('--swap-success-light');
    var gray200 = SwapUtil.getCssVariableValue('--swap-gray-200');
    var gray500 = SwapUtil.getCssVariableValue('--swap-gray-500');
    ...
    var initGraph = function () {
        var element = document.getElementById("swap_project_overview_graph");
    ...
    var initTable = function () {
        var table = document.querySelector('#swap_profile_overview_table');
        ...
        const filterOrders = document.getElementById('swap_filter_orders');
        const filterYear = document.getElementById('swap_filter_year');
