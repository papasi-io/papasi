...
// Class definition
var SwapFileManagerList = function () {
    ...
    // Private functions
    const initTemplates = () => {
        uploadTemplate = document.querySelector('[data-swap-filemanager-template="upload"]');
        renameTemplate = document.querySelector('[data-swap-filemanager-template="rename"]');
        actionTemplate = document.querySelector('[data-swap-filemanager-template="action"]');
        checkboxTemplate = document.querySelector('[data-swap-filemanager-template="checkbox"]');
    }
    ...
    const initDatatable = () => {
        ...
        var loadOptions;
        if (table.getAttribute('data-swap-filemanager-table') === 'folders') {
    ...
    const handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-swap-filemanager-table-filter="search"]');
    ...
    const handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-swap-filemanager-table-filter="delete_row"]');
    ...
    const initToggleToolbar = () => {
        ...
        if (table.getAttribute('data-swap-filemanager-table') === 'folders') {
            checkboxes = document.querySelectorAll('#swap_file_manager_list_wrapper [type="checkbox"]');
        }

        // Select elements
        const deleteSelected = document.querySelector('[data-swap-filemanager-table-select="delete_selected"]');
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-swap-filemanager-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-swap-filemanager-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-swap-filemanager-table-select="selected_count"]');
    ...
    const handleNewFolder = () => {
        // Select button
        const newFolder = document.getElementById('swap_file_manager_new_folder');
        ...
        newFolder.addEventListener('click', e => {
            ...
            if (table.querySelector('#swap_file_manager_new_folder_row')) {
                return;
            }
            ...
            const rowForm = rowElement.querySelector('#swap_file_manager_add_folder_form');
            const rowButton = rowElement.querySelector('#swap_file_manager_add_folder');
            const cancelButton = rowElement.querySelector('#swap_file_manager_cancel_folder');
            ...
            rowButton.addEventListener('click', e => {
                ...
                // Activate indicator
                rowButton.setAttribute("data-swap-indicator", "on");
                    ...
                    validator.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            setTimeout(function () {
                                ...
                                $(newRow).find('td').eq(4).attr('data-swap-filemanager-table', 'action_dropdown');
                                ...
                                // Disable indicator
                                rowButton.removeAttribute("data-swap-indicator");
            ...
            cancelButton.addEventListener('click', e => {
                ...
                // Activate indicator
                cancelButton.setAttribute("data-swap-indicator", "on");

                setTimeout(function () {
                    // Disable indicator
                    cancelButton.removeAttribute("data-swap-indicator");
    ...
    const resetNewFolder = () => {
        const newFolderRow = table.querySelector('#swap_file_manager_new_folder_row');
    ...
    const handleRename = () => {
        const renameButton = table.querySelectorAll('[data-swap-filemanager-table="rename"]');     
    ...
    const renameCallback = (e) => {
        ...
        if (table.querySelectorAll('#swap_file_manager_rename_input').length > 0) {
            Swal.fire({
        ...
        renameInput.querySelector('#swap_file_manager_rename_folder_icon').innerHTML = colIcon.outerHTML;
        ...
        parent.querySelector('#swap_file_manager_rename_input').value = nameValue;
        ...
        const renameInputButton = document.querySelector('#swap_file_manager_rename_folder');
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    const newValue = document.querySelector('#swap_file_manager_rename_input').value;
        ...
        // Cancel rename input
        const cancelInputButton = document.querySelector('#swap_file_manager_rename_folder_cancel');
        cancelInputButton.addEventListener('click', e => {
            e.preventDefault();

            // Simulate process for demo only
            cancelInputButton.setAttribute("data-swap-indicator", "on");
            ...
            setTimeout(function () {
                ...
                // Remove spinner
                cancelInputButton.removeAttribute("data-swap-indicator");
    ...
    const initDropzone = () => {
        ...
        const id = "#swap_modal_upload_dropzone";
    ...
    const initCopyLink = () => {
        ...
        const elements = table.querySelectorAll('[data-swap-filemanger-table="copy_link"]');

        elements.forEach(el => {
            // Define elements
            const button = el.querySelector('button');
            const generator = el.querySelector('[data-swap-filemanger-table="copy_link_generator"]');
            const result = el.querySelector('[data-swap-filemanger-table="copy_link_result"]');
    ...
    const handleMoveToFolder = () => {
        const element = document.querySelector('#swap_modal_move_to_folder');
        const form = element.querySelector('#swap_modal_move_to_folder_form');
        const saveButton = form.querySelector('#swap_modal_move_to_folder_submit');
        ...
        saveButton.addEventListener('click', e => {
            ...
            saveButton.setAttribute("data-swap-indicator", "on");
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    saveButton.removeAttribute("data-swap-indicator");
                                } else {
                                    Swal.fire({
    ...
    const countTotalItems = () => {
        const counter = document.getElementById('swap_file_manager_items_counter');
    ...
    return {
        init: function () {
            table = document.querySelector('#swap_file_manager_list');
