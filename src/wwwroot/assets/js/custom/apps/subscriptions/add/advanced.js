...
var SwapSubscriptionsAdvanced = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initCustomFieldsDatatable = function () {
        // Define variables
        const addButton = document.getElementById('swap_create_new_custom_fields_add');
    ...
    var deleteCustomField = function() {
        SwapUtil.on(table, '[data-swap-action="field_remove"]', 'click', function(e) {
            e.preventDefault();
    ...
    return {
        init: function () {
            table = document.getElementById('swap_create_new_custom_fields');
